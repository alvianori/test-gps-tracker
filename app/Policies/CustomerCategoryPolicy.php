...
class CustomerCategoryPolicy
{
    ...
    {
        return $user->can('view_any_customer::category');
    }
    ...
    {
        return $user->can('create_customer::category');
    }
    ...
    {
        return $user->can('delete_any_customer::category');
    }
    ...
    {
        return $user->can('force_delete_customer::category');
    }
    ...
    {
        return $user->can('force_delete_any_customer::category');
    }
    ...
    {
        return $user->can('restore_customer::category');
    }
    ...
    {
        return $user->can('restore_any_customer::category');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, CustomerCategory $customerCategory): bool
    {
        return $user->can('replicate_customer::category');
    }
    ...
    {
        return $user->can('reorder_customer::category');
    }
}
