        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('machine_number')
                    ->required()
                    ->maxLength(255),
                Forms\Components\TextInput::make('fleet_category_id')
                    ->required()
                    ->numeric(),
                Forms\Components\TextInput::make('staff_company_id')
                    ->numeric(),
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('machine_number')
                    ->searchable(),
                Tables\Columns\TextColumn::make('fleet_category_id')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('staff_company_id')
                    ->numeric()
                    ->sortable(),
